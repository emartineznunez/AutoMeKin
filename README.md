...
<code>MOPAC</code> is built-in, and the following quantum engines are interfaced with <code>AutoMeKin</code>: [Entos Qcore](https://software.entos.ai/qcore/documentation/) and [Gaussian (G09/G16)](https://gaussian.com/). 
