...
{: .warning }  
The user is advised to use this keyword exclusively for low-level calculations. It should be omitted from the input when performing high-level calculations.
